...
class ToolsUi(QDialog):
    ...
    def __init__(self, num):
        ...
        self.textBrowser_recv.insertPlainText("Dlg-%s\n" % self.num)
    ...
    def ui_translate(self):
        ...
        self.setWindowTitle(self._translate("TCP-UDP", "TCP/UDP네트워크 테스트 도구%s" % self.num))
        ...
        self.pushButton_clear.setText(self._translate("TCP-UDP", "Delete"))
        self.pushButton_send.setText(self._translate("TCP-UDP", "Send"))
        self.pushButton_exit.setText(self._translate("TCP-UDP", "Quit"))
        self.pushButton_dir.setText(self._translate("TCP-UDP", "选择路径"))
        self.pushButton_else.setText(self._translate("TCP-UDP", "new dlg"))
        self.label_ip.setText(self._translate("TCP-UDP", "기본 IP:"))
        self.label_port.setText(self._translate("TCP-UDP", "Port num:"))
        self.label_sendto.setText(self._translate("TCP-UDP", "Target IP:"))
        self.label_rev.setText(self._translate("TCP-UDP", "수신지역"))
        self.label_send.setText(self._translate("TCP-UDP", "발신지역"))
